...
const Notes = ({notes}) => {
   ...
   return (
   	<div className ='flex mx-auto w-full flex-wrap max-w-[800px] bg-myYellow items-center h-full min-h-screen'>
          ...
          <div className='w-full max-w-[800px] justify-end flex bottom-10 fixed'>
