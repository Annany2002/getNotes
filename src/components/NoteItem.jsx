...
const NoteItem = ({note}) => {
	return(
			<Link to={`/edit-note/${note.id}`}>
				<div className='text-[#fb8b24] border-2 bg-myWhite rounded-2xl break-words my-3 border-[2.5px] border-[#291720] px-2 py-2 mx-2 dark:bg-[#291720] dark:border-myWhite dark:border-[1.5px]'>
