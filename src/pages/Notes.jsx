...
const Notes = ({notes}) => {
   ...
   return (
   	<div className ='flex mx-auto w-full flex-wrap lg:w-2/3 bg-myYellow items-center max-w-[600px] h-full min-h-screen'>
          <div className='flex flex-row py-6 px-4 w-full justify-between'>
             ...
             {showSearch && <input className='text-[#291720] border-2 border-black outline-none rounded-xl bg-transparent tracking-wide font-medium px-4' value={text} placeholder = 'Keyword...' autoFocus type="text" onChange={(e) => {setText(e.target.value);handleSearch();}}/>}
          ...
          <div className='w-full justify-end flex float-right'>
