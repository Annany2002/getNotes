...
const Notes = ({dark, setDark, notes}) => {
   ...
   return (
   	<div className = 'flex my-2 rounded-xl mx-auto w-full flex-wrap lg:w-2/3 bg-myYellow items-center max-w-[600px] dark:bg-[] h-full min-h-screen'>
          ...
          {filteredNotes.length == 0 && <div className='w-full bg-red-400'> <p className='text-4xl font-mono font-bold'>No Notes found...</p></div>}
             {
